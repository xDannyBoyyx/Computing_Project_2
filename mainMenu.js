export class MainMenu extends Phaser.Scene {
    ...
    create() {
        ...
        let startButton = this.add.rectangle(320, 200, 150, 40, 0x000000, 0); // 0 alpha = invisible
        ...
        // OPTIONS button
        let optionsButton = this.add.rectangle(320, 260, 150, 40, 0x000000, 0);
        ...
        // EXIT button
        let exitButton = this.add.rectangle(320, 320, 150, 40, 0x000000, 0);
